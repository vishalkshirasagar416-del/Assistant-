...
import com.deva.voice.v2.llm.GeminiProvider
    ...
    suspend fun generateContent(
        ...
        while (attempts < maxRetry) {
            ...
            try {
                ...
                // Gemini is PRIMARY.
                // OpenRouter is AUTOMATIC FALLBACK.
                val providerMessages = chat.map { (role, parts) ->
                    GeminiMessage(
                        role = when (role.lowercase()) {
                            "model", "assistant" -> MessageRole.MODEL
                ...
                Log.d("GeminiApi", "=== AI RESPONSE (Attempt ${attempts + 1}) ===")
                Log.d("GeminiApi", "Request time: ${requestTime}ms")

                Log.d("GeminiApi", "AI response received successfully.")
                ...
                val logEntry = createLogEntry(
                    ...
                    payload = "Gemini -> OpenRouter provider flow",
                    responseCode = 200,
